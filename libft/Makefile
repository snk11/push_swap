...
#    Updated: 2017/01/16 00:32:15 by syusof           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ft_isprint.c ft_itoa.c ft_lldtoa.c ft_lstadd.c ft_memalloc.c \
	  ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memdel.c \
	  ft_memmove.c ft_memmove2.c ft_memset.c ft_putchar.c ft_putchar_fd.c \
	  ...
	  ft_strsub.c ft_strtrim.c ft_tolower.c ft_toupper.c ft_ustoa.c
